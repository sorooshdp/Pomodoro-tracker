...
export function shadowHandle(
    ...
    switch (mode) {
        case Mode.Focus:
            ...
            index.setProperty(
                "--shadow-length",
                `${calcShadowLength(global.seconds, global.focusLength, h)}px`,
            )
            break
        case Mode.LongBreak:
            ...
            index.setProperty(
                "--shadow-length",
                `${calcShadowLength(global.seconds, global.longBreakLength, h)}px`,
            )
            break
        case Mode.ShortBreak:
            ...
            index.setProperty(
                "--shadow-length",
                `${calcShadowLength(global.seconds, global.shortBreakLength, h)}px`,
            )
            break
    }
}
